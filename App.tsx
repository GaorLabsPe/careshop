...
import { ShieldCheck, ArrowRight, ShoppingBag, Globe, Settings } from 'lucide-react';
...
const AppContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      {/* Floating Admin Button - Only for Dev/Store Owner */}
      <button 
        onClick={() => navigate('admin')}
        className="fixed left-6 bottom-6 bg-slate-900 text-white p-4 rounded-full shadow-2xl z-[70] hover:bg-slate-800 transition-all border-2 border-white"
      >
        <Settings size={20} />
      </button>
